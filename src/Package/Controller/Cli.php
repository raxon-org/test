...
namespace Package\Raxon\Org\Test\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} raxon_org/test                    | Test options',
        '{{binary()}} raxon_org/test setup              | Test setup',
        '{{binary()}} raxon_org/test run                | Run tests'
    ];
